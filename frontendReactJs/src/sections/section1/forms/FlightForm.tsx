...
export const FlightForm: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      {/* <div className="absolute mx-[480px] mt-6 "> */}
      <div className=" w-full flex items-center justify-center   ">
        <Link to="/results">
          <button type="submit" className="mt-5 inline-flex items-center py-2.5 px-3 ms-2 text-sm font-bold text-black bg-[#FFF7D3] rounded-lg  hover:bg-white ">
