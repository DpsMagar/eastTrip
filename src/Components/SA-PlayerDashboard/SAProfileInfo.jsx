            ...
            <div className="radio-group">
              ...
              <label className="radio-label">
                <input
                  ...
                  onChange={handleChange}
                />
                <span className="radio-text">Unmarried</span>
              </label>
            </div>
          </div>
        </div>

        <h3 className="subsection-title">Passport Details</h3>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              ...
              id="passport-no"
              name="passport no"
              value={formData["passport no"]}
              onChange={handleChange}
            />
          </div>

          <div className="form-group">
            <label htmlFor="issuing-place">Issuing Place</label>
            <input
              type="text"
              id="issuing-place"
              name="Issuing place"
              value={formData["Issuing place"]}
              onChange={handleChange}
            />
          </div>
        </div>
