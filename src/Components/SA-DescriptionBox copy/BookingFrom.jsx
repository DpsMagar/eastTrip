...
const BookingForm = ({ hotelInfo }) => {
  ...
  return (
    <div className="t-booking-form">
      <div className="t-price-header">
        <h2 className="t-per-night-price">NPR {hotelInfo.price }</h2>
        <span className="t-per-night-label">per night</span>
      </div>

      <div className="t-price-breakdown">
        <div className="t-price-row">
          <span className="t-price-label">Base Price</span>
          <span className="t-price-value">NPR {basePrice -416}</span>
        </div>
        <div className="t-price-row">
          <span className="t-price-label">Taxes & Fees</span>
          <span className="t-price-value">NPR {taxesAndFees.toLocaleString()}</span>
        </div>
        <div className="t-price-row total-row">
          <span className="t-price-label">Total</span>
          <span className="t-price-value">NPR {hotelInfo.price}</span>
        </div>
        <div className="t-price-row">
          <span className="t-reward-label">Reward Points</span>
          <span className="t-reward-value">{RewardPoint.toLocaleString()}</span>
        </div>
      </div>
